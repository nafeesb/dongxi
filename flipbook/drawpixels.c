/*!
  ...
  $Id: drawpixels.c,v 1.1.1.1 2003/02/20 08:51:07 nafees Exp $
  ...
  drawpixels 640 480 d  # typical video playback
  drawpixels 1024 554 d # typical 1/2 rez film with letterbox
  drawpixels 1024 778 d # typical 1/2 rez full-ap film
  drawpixels 2048 1107 d # typical full-rez film with letterbox
  drawpixels 2048 1556 d # full rez full-ap film
  drawpixels 1828 1371 d # full rez acadamy frame
  drawpixels 1828 685 d  # anamorphic acadamy images, 1/2 rez vertically
  ...
  Linux:
  cc -O2 drawpixels.c -o drawpixels -L/usr/X11R6/lib -lGL -lX11 -lXext

  Irix:
  cc -o drawpixels drawpixels.c -lGL -lX11 -lXext
  
  NT:
  cl -O2 drawpixels.c OpenGL32.lib gdi32.lib user32.lib
*/
...
int main(int argc, char **argv) {
  ...
  for (i = 0; ; i++) {
    ...
    glDrawPixels(width, height, format, GL_UNSIGNED_BYTE,
		 images+(i%NUMIMAGES)*width*height);
    glFlush();
